...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    ...
    hash = "sha256-Y4l7Qfu737HEktPE3uHttCJCgqB7vfRCpKaMGbzBiGI=";
  };
  ...
  configureFlags = [
    ...
    "--enable-fpu"
    "--enable-gdb-stub" # conflicts with debugger option
  ...
  patches = [ ./src/misc/bochs-2.6.11-banner-stderr.patch ./src/misc/bochs-2.6.11-link-tinfo.patch ./src/misc/bochs-2.6.11-jitter-plus-segv.patch ];
