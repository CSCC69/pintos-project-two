...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [ ./src/misc/bochs-2.6.11-banner-stderr.patch ./src/misc/bochs-2.6.11-link-tinfo.patch ./src/misc/bochs-2.6.11-jitter-plus-segv.patch ./src/misc/dbg-smp.patch ];
